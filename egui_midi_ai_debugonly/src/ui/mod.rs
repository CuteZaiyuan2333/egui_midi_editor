        ...
        ui.horizontal(|ui| {
            ...
            ui.vertical(|ui| {
                ...
                if self.curve_lane_visible {
                    ...
                    painter.rect_stroke(splitter_rect, 0.0, Stroke::new(1.0, Color32::from_rgb(150, 150, 150)), StrokeKind::Middle);
            ...
            .show(ui, |ui| {
                ...
                for i in 0..=127 {
                    ...
                    if y > rect.min.y + timeline_height && y < rect.max.y {
                        ...
                        painter.rect_stroke(key_rect, 0.0, Stroke::new(1.0, Color32::GRAY), StrokeKind::Middle);
